...
-(void)createTable{
    life = [[NSMutableArray alloc]init];
    [life addObject:[[NSMutableDictionary alloc]
                     initWithObjectsAndKeys:@"Biographies",@"name",
                     @"biographies.png",@"pic",@"http://www.google.com/search?sourceid=chrome&ie=UTF-8&q=gandhi+biographies",
                     @"url", nil]];
    [life addObject:[[NSMutableDictionary alloc]
                     initWithObjectsAndKeys:@"Images", @"name",
                     @"gandhi.png",@"pic",@"http://www.google.com/search?q=mahatma+gandhi&um=1&ie=UTF-8&hl=en&tbm=isch&source=og&sa=N&tab=wi&biw=1276&bih=639&sei=D9nrToLiIYefgweSm-SACQ",@"url", nil]];
    [life addObject:[[NSMutableDictionary alloc]
                     initWithObjectsAndKeys:@"In Popular Culture",@"name",
                     @"pop.png",@"pic",@"http://www.google.com/search?sourceid=chrome&ie=UTF-8&q=gandhi+in+popular+culture",
                     @"url", nil]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[cell textLabel]setText:[[life objectAtIndex:indexPath.row]objectForKey:@"name"]];
    cell.textLabel.shadowColor = [UIColor lightGrayColor];
    cell.textLabel.shadowOffset = CGSizeMake(1, 1);
	
	[[cell imageView]setImage:[UIImage imageNamed:[[life objectAtIndex:indexPath.row]objectForKey:@"pic"]]];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headerLabel.text = @"\"You must be the change you wish to see in the world.\"";
    headerLabel.frame = CGRectMake(10.0, 0.0, 300.0, 80.0);
